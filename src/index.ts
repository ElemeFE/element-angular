...
const ElChildModules: any = {
  ...
  ElSharedModule, ElNotificationModule, ElCascaderModule, ElBadgesModule, ElCardsModule,
}
...
@NgModule({
  imports: [
    ...
    ElCascaderModule.forRoot(), ElBadgesModule.forRoot(), ElCardsModule.forRoot(),
